import { BabyFurniture } from './baby-furniture.interface';

export const BABYFURNITURE: BabyFurniture[] = [
    {
        id: 1,
        ...
        size: "90 x 55 x 13 cm",
        weight: "1.5 kg",
        color: "Minze Igel mit minzer Minky",
